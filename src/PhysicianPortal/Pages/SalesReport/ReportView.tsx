      ...
      <div className="flex flex-col md:flex md:items-center justify-between gap-2">
        <div>
          ...
          <p className="text-gray-600 text-sm mt-1">
            Year to Date • Jan 26 - Dec 26, 2025
          </p>
        </div>
                    ...
                    <div className="flex items-start justify-between gap-3 mb-3">
                      <div className="flex items-center gap-3 flex-1 min-w-0">
                        ...
                        <div className="flex-1 min-w-0">
                          <p
                            className={`font-bold text-base mb-1 truncate text-slate-800`}
                          >
                            {rep.salesRep}
                          </p>
                      ...
                      {isSelected && (
                        <CheckCircle2 className="w-5 h-5 text-app-primary flex-shrink-0" />
                      )}
                    </div>
                  </button>
                );
            ...
            <div className="space-y-4 max-h-[500px] overflow-y-auto pr-2">
              {selectedRepData.clients.map((client, idx) => {
                ...
                const maxValue = Math.max(
                  ...selectedRepData.clients.flatMap((c) => c.monthlyOrders)
                );
                        ...
                        <div className="flex items-center gap-4 flex-1 min-w-0">
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-slate-500 font-medium">
                              Account #{String(idx + 1).padStart(4, "0")}
                            </p>
                          </div>
                        </div>
