  ...
  return (
    <div className="space-y-6 px-4">
      ...
      <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 xl:grid-cols-7 gap-6">
            <div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-end col-span-2 mt-4 gap-3">
            <button
              type="button"
